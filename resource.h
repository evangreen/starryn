...
#define IDE_STARS_COUNT 105
#define IDE_LIGHTS_COUNT 106
#define IDC_FLASHER 107
...
#define STARS_COUNT_OFFSET_Y \
    (BUILDING_COUNT_OFFSET_Y + UI_LINE_HEIGHT + (2 * UI_BORDER))

#define LIGHTS_COUNT_OFFSET_Y \
    (STARS_COUNT_OFFSET_Y + UI_LINE_HEIGHT + (2 * UI_BORDER))

#define FLASHER_OFFSET_Y \
    (LIGHTS_COUNT_OFFSET_Y + UI_LINE_HEIGHT + (2 * UI_BORDER))
